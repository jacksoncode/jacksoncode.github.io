...
- **框架**: 纯静态HTML + Bootstrap 5.3.8
- **自定义模块**: 20+个JavaScript模块（dark-mode、theme-manager、search-enhanced、reading-progress、knowledge-graph等）
- **PWA支持**: Service Worker + Web App Manifest（ai-notes模块）
- **构建工具**: npm scripts（optimize:images、optimize:css、lighthouse、lint、format）

## 最近更新 (2026-06-20)

- ✅ 暗色模式补全：ch28/ch32添加dark-mode引用
- ✅ 图片懒加载：blog/av/ai-notes添加loading="lazy"
- ✅ CSS暗色增强：ai-notes.css补充nav/toggle/标题样式
- ✅ SEO优化：ai-notes添加Open Graph标签，sitemap追加44条目
- ✅ 资源压缩配置：npm脚本已完善
- ✅ 错误处理：各模块catch完善，404页面优化
- ✅ 性能监控：Lighthouse CI脚本配置
