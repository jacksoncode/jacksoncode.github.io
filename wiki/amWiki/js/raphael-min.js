...
((function (a) {
    var b = '0.3.4',
        ...
        k = function (a, b) {
            ...
            for (var t = 0, u = f.length; t < u; t++)
                'zIndex' in f[t] &&
                    (o.push(f[t].zIndex), f[t].zIndex < 0 && (p[f[t].zIndex] = f[t]));
            o.sort(g);
            while (o[l] < 0) {
    ...
    (function () {
            ...
            if (f)
                for (y = 0, z = cy.length; y < z; y++) {
                    ...
                    if (x.el.id == d.id && x.anim == b) {
                        (x.percent != e ? (cy.splice(y, 1), (l = 1)) : (k = x),
        ...
        function bH(b, c, d) {
            ...
            for (var p = 0, q = b.length; p < q; p++) {
                ...
                if (r[0] == 'M') ((e = i = r[1]), (f = j = r[2]));
                    ...
                    r[0] == 'C'
                        ? ((m = [e, f].concat(r.slice(1))), (e = m[6]), (f = m[7]))
                        : ((m = [e, f, e, f, i, j, i, j]), (e = i), (f = j));
                    for (var s = 0, t = c.length; s < t; s++) {
                        var u = c[s];
                        if (u[0] == 'M') ((g = k = u[1]), (h = l = u[2]));
                        else {
                            u[0] == 'C'
                                ? ((n = [g, h].concat(u.slice(1))), (g = n[6]), (h = n[7]))
                                : ((n = [g, h, g, h, k, l, k, l]), (g = k), (h = l));
                            var v = bG(m, n, d);
                            if (d) o += v;
                            else {
                ...
                for (var q = 0; q < j; q++) {
                    ...
                    if (x) {
                        ...
                        y >= 0 &&
                            ...
                            A >= 0 &&
                            A <= 1 &&
                            (d ? n++ : n.push({ x: x.x, y: x.y, t1: y, t2: A }));
                    }
                }
            return n;
        }
        ...
        function bD(a, b, c, d, e, f, g, h) {
            if (
                !(x(a, c) < y(e, g) || y(a, c) > x(e, g) || x(b, d) < y(f, h) || y(b, d) > x(f, h))
            ) {
        ...
        ((a.findDotsAtSegment = function (a, b, c, d, e, f, g, h, i) {
            ...
            (a.isBBoxIntersect = function (b, c) {
                ...
                return (
                    ...
                    d(b, c.x, c.y2) ||
                    d(b, c.x2, c.y2) ||
                    (((b.x < c.x2 && b.x > c.x) || (c.x < b.x2 && c.x > b.x)) &&
                        ((b.y < c.y2 && b.y > c.y) || (c.y < b.y2 && c.y > b.y)))
                );
            }),
        ...
        var bI = (a.pathBBox = function (a) {
            ...
            bK = (a._pathToRelative = function (b) {
                ...
                var d = [],
                    ...
                    i = 0;
                b[0][0] == 'M' &&
                    ((e = b[0][1]), (f = b[0][2]), (g = e), (h = f), i++, d.push(['M', e, f]));
            ...
            bL = (a._pathToAbsolute = function (b) {
                ...
                var d = [],
                    ...
                    i = 0;
                b[0][0] == 'M' &&
                    ((e = +b[0][1]), (f = +b[0][2]), (g = e), (h = f), i++, (d[0] = ['M', e, f]));
                var j =
                    b.length == 3 &&
                    b[0][0] == 'M' &&
                    b[1][0].toUpperCase() == 'R' &&
            ...
            bO = function (a, b, c, d, e, f, g, h, i, j) {
                ...
                if (!j) {
                    ...
                    var x = c * c,
                        ...
                        A =
                            (f == g ? -1 : 1) *
                            w.sqrt(z((x * y - x * u * u - y * t * t) / (x * u * u + y * t * t))),
                        C = (A * c * u) / d + (a + h) / 2,
                        D = (A * -d * t) / c + (b + i) / 2,
            ...
            bQ = bv(function (a, b, c, d, e, f, g, h) {
                ...
                (z(l) > '1e12' && (l = 0.5),
                    ...
                    l > 0 &&
                        l < 1 &&
                        ((q = bP(a, b, c, d, e, f, g, h, l)), p.push(q.x), o.push(q.y)),
                    n > 0 &&
                        n < 1 &&
                        ((q = bP(a, b, c, d, e, f, g, h, n)), p.push(q.x), o.push(q.y)),
                    (i = f - 2 * d + b - (h - 2 * f + d)),
                    (j = 2 * (d - b) - 2 * (f - d)),
                    (k = b - d),
                    (l = (-j + w.sqrt(j * j - 4 * i * k)) / 2 / i),
            ...
            bU = (a._tofront = function (a, b) {
                b.top !== a &&
                    (bT(a, b), (a.next = null), (a.prev = b.top), (b.top.next = a), (b.top = a));
            }),
                ...
                ((b.add = function (a, b, c, d, e, f) {
                    ...
                    (b.split = function () {
                        ...
                        var f = -e[0][1],
                            g = e[1][1];
                        (g < 0
                            ? ((b.rotate = a.deg(w.acos(g))), f < 0 && (b.rotate = 360 - b.rotate))
        ...
        (navigator.vendor == 'Apple Computer, Inc.' &&
            ((cc && cc[1] < 4) || navigator.platform.slice(0, 2) == 'iP')) ||
        (navigator.vendor == 'Google Inc.' && cc && cc[1] < 8)
            ? (k.safari = function () {
        ...
        ((cl.drag = function (b, c, d, e, f, g) {
            ...
            (cl.onDragOver = function (a) {
                a
                    ? eve.on('raphael.drag.over.' + this.id, a)
        ...
        var cr = {},
            cs = function (b, c, d, e, f, g, h, i, j) {
                return j == null
                    ? bB(b, c, d, e, f, g, h, i)
                    : a.findDotsAtSegment(b, c, d, e, f, g, h, i, bC(b, c, d, e, f, g, h, i, j));
            },
            ct = function (b, c) {
                return function (d, e, f) {
                    ...
                    ((l.end = k),
                        (m = b
                            ...
                            : c
                              ? l
                              : a.findDotsAtSegment(g, h, i[0], i[1], i[2], i[3], i[4], i[5], 1)),
            ...
            cA = function () {
                ...
                for (; c < cy.length; c++) {
                    ...
                    var e = b - d.start,
                        ...
                        s;
                    d.initstatus
                        ? ((e = ((d.initstatus * d.anim.top - d.prev) / (d.percent - d.prev)) * f),
                          (d.status = d.initstatus),
                          delete d.initstatus,
                          d.stop && cy.splice(c--, 1))
                    ...
                    if (e < f) {
                                ...
                                switch (U[u]) {
                                    ...
                                    case 'colour':
                                        p =
                                            'rgb(' +
                                            [
                                                cB(O(i[u].r + t * f * j[u].r)),
                                                cB(O(i[u].g + t * f * j[u].g)),
                                                cB(O(i[u].b + t * f * j[u].b)),
                                            ].join(',') +
                                            ')';
                                        break;
                                    case 'path':
                        ...
                        d.next &&
                            !d.stop &&
                            cE(d.anim, d.el, d.next, null, d.totalOrigin, d.repeat);
                    }
                }
        ...
        ((cl.animateWith = function (b, c, d, e, f, g) {
            ...
            (cl.onAnimation = function (a) {
                a
                    ? eve.on('raphael.anim.frame.' + this.id, a)
            ...
            (cl.pause = function (a) {
                for (var b = 0; b < cy.length; b++)
                    cy[b].el.id == this.id &&
                        (!a || cy[b].anim == a) &&
                        eve('raphael.anim.pause.' + this.id, this, cy[b].anim) !== !1 &&
                        (cy[b].paused = !0);
                return this;
            }),
            ...
            (cl.stop = function (a) {
                for (var b = 0; b < cy.length; b++)
                    cy[b].el.id == this.id &&
                        (!a || cy[b].anim == a) &&
                        eve('raphael.anim.stop.' + this.id, this, cy[b].anim) !== !1 &&
                        cy.splice(b--, 1);
                return this;
            }),
        ...
        var cG = function (a) {
                ...
                if (a)
                    for (var b = 0, c = a.length; b < c; b++)
                        a[b] &&
                            (a[b].constructor == cl.constructor || a[b].constructor == cG) &&
        ...
        ((cH.push = function () {
            ...
            for (var c = 0, d = arguments.length; c < d; c++)
                ((a = arguments[c]),
                    a &&
                        (a.constructor == cl.constructor || a.constructor == cG) &&
                ...
                t = function (d, e, f) {
                    if (d.type == 'path') {
                        ...
                        if (r != 'none') {
                            ...
                            (f
                                ? ((s = d._.arrows.startdx * m || 0),
                                  (t = a.getTotalLength(k.path) - F * m))
                                : ((s = F * m),
                        ...
                        if (f[b](o)) {
                            ...
                            switch (o) {
                                ...
                                case 'target':
                                    ...
                                    o == 'target'
                                        ? u.setAttributeNS(n, 'show', p == 'blank' ? 'new' : p)
            ...
            ((z.prototype = A),
                ...
                (a.prototype.renderfix = function () {
                    ...
                    var e = -c.e % 1,
                        f = -c.f % 1;
                    if (e || f)
                        (e && ((this._left = (this._left + e) % 1), (b.left = this._left + 'px')),
                            ...
                            ((l = 'radial'),
                                b &&
                                    ...
                                    i(b - 0.5, 2) + i(c - 0.5, 2) > 0.25 &&
                                        (c =
                                            e.sqrt(0.25 - i(b - 0.5, 2)) * ((c > 0.5) * 2 - 1) +
                                            0.5),
                                    (m = b + n + c)));
                            return o;
                        })),
